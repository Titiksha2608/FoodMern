...
export const createRestaurant = async (
  ...
  try {
    ...
    // Upload the image and create the restaurant
    ...
    await Restaurant.create({
      ...
      country,
      deliveryTime,
      cuisines: JSON.parse(cuisines), // Parse cuisines if sent as a JSON string
      imageUrl,
    });
...
export const updateRestaurant = async (
  ...
  try {
    ...
    restaurant.cuisines = JSON.parse(cuisines); // Parse cuisines from form data
    ...
    await restaurant.save(); // Save updated data
...
export const getSingleRestaurant = async (
  ...
  try {
    ...
    const restaurant = await Restaurant.findById(restaurantId).populate({
      path: "menus",
      options: { sort: { createdAt: -1 } }, // Ensure sorting order is correct
    });
